...
const HowItWorks = () => {
  return (
    <div className="how-it-works-container mt-5">
      <h1 className="title mt-0">How the Mentorship Program Works</h1>
      <ol className="steps-list">
        <li>
          <h2>1. Identification of Mentors and Mentees</h2>
          <p>
        ...
        <li>
          <h2>4. Orientation and Goal Setting</h2>
          <p>
        ...
        <li>
          <h2>5. Establishment of Mentorship Relationship</h2>
          <p>
        ...
        <li>
          <h2>6. Knowledge Sharing and Guidance</h2>
          <p>
        ...
        <li>
          <h2>7. Career and Personal Development Support</h2>
          <p>
        ...
        <li>
          <h2>8. Continuous Learning and Skill Building</h2>
          <p>
        ...
        <li>
          <h2>10. Closure and Transition</h2>
          <p>
